...
public class IstanbulCity extends City {
    public IstanbulCity(Point2D location) {
        super("Istanbul", location, 200);
    }
    ...
    public void produceResources() {
        ...
        producedResources.put(ResourceType.MEAT, getRandomizedProduction(60));
        producedResources.put(ResourceType.WATER, getRandomizedProduction(20));
        producedResources.put(ResourceType.WINE, getRandomizedProduction(25));
        producedResources.put(ResourceType.APPLE, getRandomizedProduction(30));
        producedResources.put(ResourceType.PEAR, getRandomizedProduction(35));
        producedResources.put(ResourceType.STEEL, getRandomizedProduction(20));
    ...
    public void consumeResources() {
        ...
        double meatConsumptionRate = 0.5; // %50'lik tüketim oranı
        double waterConsumptionRate = 0.8; // %80'lik tüketim oranı
        double wineConsumptionRate = 0.6; // %60'lik tüketim oranı
        double appleConsumptionRate = 0.4; // %40'lik tüketim oranı
        double pearConsumptionRate = 0.5; // %50'lik tüketim oranı
        double steelConsumptionRate = 0.3; // %30'lik tüketim oranı
