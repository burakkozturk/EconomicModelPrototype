...
public class AnkaraCity extends City {
    public AnkaraCity(Point2D location) {
        super("Ankara", location, 100);
    }
    ...
    public void produceResources() {
        ...
        producedResources.put(ResourceType.MEAT, getRandomizedProduction(50));
        producedResources.put(ResourceType.WATER, getRandomizedProduction(30));
        producedResources.put(ResourceType.WINE, getRandomizedProduction(20));
        producedResources.put(ResourceType.APPLE, getRandomizedProduction(40));
        producedResources.put(ResourceType.PEAR, getRandomizedProduction(25));
        producedResources.put(ResourceType.STEEL, getRandomizedProduction(15));
    ...
    public void consumeResources() {
        ...
        double meatConsumptionRate = 0.7; // %70'lik tüketim oranı
        double waterConsumptionRate = 0.8; // %80'lik tüketim oranı
        double wineConsumptionRate = 0.5; // %50'lik tüketim oranı
        double appleConsumptionRate = 0.6; // %60'lik tüketim oranı
        double pearConsumptionRate = 0.5; // %50'lik tüketim oranı
        double steelConsumptionRate = 0.4; // %40'lik tüketim oranı
